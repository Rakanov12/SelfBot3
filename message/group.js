...
module.exports = async(client, anu) => {
  	try{
            ...
            const intro = `Hallo ${pushname} 😺 \n\n═════ *WELCOME* ══════ \n\n═══════════════════ \n╭────❉ *INTRO* ❉────── \n│➸ *Nama*   : \n│➸ *Gender* : \n│➸ *Askot*   : \n│➸ *Usia*      : \n╰────────────────── \n═══════════════════ \n     *Selamat Datang Di Group \nSemoga Betah Yah dan Jangan \n     Lupa Baca Rules Group 😁* \n       ═══════════════════`;
            const outro = `═════❰ Byee ${pushname} ❉ \n\n═══════════════════ \n    *Jasa Mu Akan Di Kenang Di \n        Dalam Grub Dan Semoga \n          Sehat Selalu Kawand* \n═══════════════════`
...
//Welcome Type1
             ...
             if(!JSON.parse(fs.readFileSync('./database/welkom.json')).includes(anu.jid)) return
              ...
              buttons = [{ buttonId: `y`, buttonText: { displayText: "Byee kwand" }, type: 1 }
              ];        
